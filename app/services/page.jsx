    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .mega-trigger { font-size: 13.5px; font-weight: 500; color: #333; padding: 7px 13px; border-radius: 6px; cursor: pointer; display: flex; align-items: center; gap: 4px; white-space: nowrap; list-style: none; }
        ...
        .hero h1 { font-family: 'Cormorant Garamond', serif; font-size: clamp(2.2rem,5vw,3.8rem); font-weight: 700; color: #fff; line-height: 1.1; margin-bottom: 1.1rem; }
        .hero h1 em { color: #c8e88a; font-style: normal; }
        .hero p { font-size: 15px; color: rgba(255,255,255,0.8); line-height: 1.8; margin-bottom: 2rem; max-width: 560px; margin-left: auto; margin-right: auto; }
        ...
        .hero-stats { display: grid; grid-template-columns: repeat(4,1fr); gap: 1rem; max-width: 680px; margin: 0 auto; padding-top: 2.5rem; border-top: 1px solid rgba(255,255,255,0.15); }
        ...
        .breadcrumb-inner { max-width: 1280px; margin: 0 auto; display: flex; align-items: center; gap: 8px; flex-wrap: wrap; }
        ...
        /* SERVICE CARD */
        .svc-card { background: var(--white); border: 1px solid rgba(155,193,76,0.15); border-radius: 18px; overflow: hidden; transition: transform 0.25s, box-shadow 0.25s, border-color 0.25s; display: flex; flex-direction: column; text-decoration: none; color: inherit; }
        ...
        .banner1-overlay { position: absolute; inset: 0; background: linear-gradient(to right, rgba(20,32,8,0.9) 0%, rgba(20,32,8,0.6) 55%, rgba(20,32,8,0.1) 100%); }
        ...
        .banner2 img { position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; object-position: center; }
        .banner2-overlay { position: absolute; inset: 0; background: linear-gradient(to left, rgba(20,32,8,0.9) 0%, rgba(20,32,8,0.6) 55%, rgba(20,32,8,0.1) 100%); }
        ...
        @media (max-width: 900px) {
          ...
          .banner2-overlay { background: linear-gradient(to right, rgba(20,32,8,0.9) 0%, rgba(20,32,8,0.6) 55%, rgba(20,32,8,0.1) 100%); }
        ...
        @media (max-width: 480px) {
          ...
          .banner-btns, .banner2-btns { flex-direction: column; }
        }
        ...
        <div className="svc-inner">
          <div className="svc-header">
            ...
            <h2 className="section-title">
              {activeTab === 'all' ? 'All Our Services' : categories.find(c => c.id === activeTab)?.label}
            </h2>
              ...
              <div className="svc-card" key={s.title}>
                <div className="svc-img-wrap">
                  ...
                  <div className="svc-img-ph" style={{display:'none'}}>
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
                  </div>
      ...
      {/* BANNER 1 — Pool & Landscape */}
      <div className="banner1">
        <img src="/pool6.webp" alt="Pool and Landscape Services" />
        ...
        <div className="banner1-content">
          ...
          <div className="banner-btns">
            ...
            <a href="/services/exterior-renovation" className="btn-outline-white">View Pool Services</a>
          </div>
        </div>
      </div>
      ...
      <div className="banner2">
        <img src="/Interior7.jpg" alt="Interior Renovation Services" />
        ...
        <div className="banner2-content">
          ...
          <div className="banner2-btns">
            ...
            <a href="/services/interior-renovation" className="btn-outline-white">Interior Services</a>
          </div>
        </div>
      </div>
        ...
        <div className="footer-main">
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><a href="/services/technical">Flooring & Tiling</a></li>
            </ul>
          </div>
          <div className="footer-col">
            <h4>Technical</h4>
            <ul>
              ...
              <li><a href="/services/exterior-renovation">Pool Construction</a></li>
              <li><a href="/services/exterior-renovation">Landscaping</a></li>
            </ul>
          </div>
          <div className="footer-col">
            <h4>Company</h4>
