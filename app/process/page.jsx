...
export default function ProcessPage() {
  ...
  const steps = [
    {
      n: '01',
      icon: <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.62 3.38 2 2 0 0 1 3.58 1.2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 9.22a16 16 0 0 0 5.87 5.87l1.09-1.09a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.5 16z"/></svg>,
      title: 'Free Consultation',
      desc: 'Call or WhatsApp us on +971 55 974 7416. We listen to your requirements, understand your vision, and guide you to the best solution for your budget and timeline.',
      points: ['No cost, no obligation', 'Available 7 days a week', 'Phone, WhatsApp or in-person'],
    },
    {
      n: '02',
      icon: <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>,
      title: 'Site Visit & Survey',
      desc: 'Our expert team visits your property to assess the scope of work, take accurate measurements, and understand your space in detail before preparing your proposal.',
      points: ['Free site visit across Dubai', 'Detailed measurements taken', 'Scope clearly defined'],
    },
    {
      n: '03',
      icon: <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>,
      title: 'Detailed Proposal',
      desc: 'We present a comprehensive proposal including material specifications, project timeline, and a fully transparent, fixed price. No surprises, no hidden costs.',
      points: ['Fixed price — no hidden fees', 'Clear project timeline', 'Material specifications included'],
    },
    {
      n: '04',
      icon: <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>,
      title: 'Expert Execution',
      desc: 'Once approved, our skilled craftsmen begin work. We keep you updated throughout with regular progress reports and ensure minimal disruption to your daily routine.',
      points: ['Skilled, experienced team', 'Regular progress updates', 'Minimal disruption guaranteed'],
    },
    {
      n: '05',
      icon: <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>,
      title: 'Handover & After-Care',
      desc: 'We conduct a full walkthrough with you, address any final touches, and hand over your completed project. Our after-care support ensures your complete satisfaction.',
      points: ['Final walkthrough together', 'Workmanship warranty included', '24/7 after-care support'],
    },
  ];

  const promises = [
    { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>, title: 'On-Time Delivery', desc: 'We set realistic timelines and deliver on them — every time.' },
    { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>, title: 'Transparent Pricing', desc: 'Fixed quotes with no hidden costs — you pay exactly what we quote.' },
    { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>, title: 'Quality Guaranteed', desc: 'All work covered by our workmanship warranty for your peace of mind.' },
    { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>, title: 'Dedicated Team', desc: 'One dedicated project manager from start to finish — always reachable.' },
  ];
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* STEPS SECTION */
        .steps-section { background: var(--white); padding: clamp(3rem,6vw,5rem) 1.5rem; }
        .steps-inner { max-width: 1000px; margin: 0 auto; }
        .steps-list { display: flex; flex-direction: column; gap: 0; }
        .step-item { display: grid; grid-template-columns: auto 1fr; gap: 0 2rem; position: relative; padding-bottom: 2.5rem; }
        .step-item:last-child { padding-bottom: 0; }
        /* Vertical line between steps */
        .step-item:not(:last-child) .step-left::after { content: ''; position: absolute; left: 27px; top: 60px; bottom: 0; width: 2px; background: linear-gradient(to bottom, var(--green-light), rgba(155,193,76,0.15)); }
        .step-left { display: flex; flex-direction: column; align-items: center; position: relative; width: 56px; flex-shrink: 0; }
        .step-circle { width: 56px; height: 56px; border-radius: 50%; background: var(--green-light); display: flex; align-items: center; justify-content: center; flex-shrink: 0; box-shadow: 0 4px 20px rgba(155,193,76,0.3); position: relative; z-index: 1; }
        .step-right { padding-top: 8px; }
        .step-num { font-size: 11px; font-weight: 700; color: var(--green-dark); letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 4px; }
        .step-right h3 { font-family: 'Cormorant Garamond', serif; font-size: 1.7rem; font-weight: 700; color: #1a1a1a; margin-bottom: 0.6rem; }
        .step-right p { font-size: 14.5px; color: var(--muted); line-height: 1.75; margin-bottom: 0.85rem; }
        .step-points { display: flex; flex-wrap: wrap; gap: 8px; }
        .step-point { display: flex; align-items: center; gap: 6px; font-size: 12.5px; font-weight: 500; color: var(--green-dark); background: rgba(155,193,76,0.08); border: 1px solid rgba(155,193,76,0.2); padding: 4px 12px; border-radius: 100px; }
        .step-point::before { content: ''; width: 5px; height: 5px; border-radius: 50%; background: var(--green-light); flex-shrink: 0; }

        /* PROMISES */
        .promises-section { background: var(--green-light); padding: clamp(2.5rem,5vw,4rem) 1.5rem; }
        .promises-inner { max-width: 1100px; margin: 0 auto; }
        .promises-header { text-align: center; margin-bottom: 2rem; }
        .promises-header .section-tag { color: var(--green-deeper); background: rgba(255,255,255,0.25); border-color: rgba(255,255,255,0.35); }
        .promises-header h2 { font-family: 'Cormorant Garamond', serif; font-size: clamp(1.8rem,4vw,2.6rem); font-weight: 700; color: #fff; }
        .promises-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(220px,1fr)); gap: 1.25rem; }
        .promise-card { background: rgba(255,255,255,0.15); border: 1px solid rgba(255,255,255,0.25); border-radius: 14px; padding: 1.5rem; transition: background 0.2s; }
        .promise-card:hover { background: rgba(255,255,255,0.22); }
        .promise-icon { width: 48px; height: 48px; background: rgba(255,255,255,0.2); border-radius: 12px; display: flex; align-items: center; justify-content: center; margin-bottom: 0.85rem; color: #fff; }
        .promise-card h4 { font-size: 15px; font-weight: 600; color: #fff; margin-bottom: 5px; }
        .promise-card p { font-size: 13px; color: rgba(255,255,255,0.82); line-height: 1.65; }
        ...
        @media (max-width: 600px) {
          ...
          .footer-main { grid-template-columns: 1fr 1fr; }
          .step-item { grid-template-columns: auto 1fr; gap: 0 1.25rem; }
          .step-item:not(:last-child) .step-left::after { left: 23px; }
          .step-circle { width: 48px; height: 48px; }
          .step-left { width: 48px; }
        }
      ...
      <nav>
        <div className="nav-inner">
          ...
          <ul className="nav-list">
            ...
            <li><a href="/process" className="active">Our Process</a></li>
      ...
      <section className="hero">
        <div className="hero-content">
          <div className="breadcrumb">
            <a href="/">Home</a>
            <span>›</span>
            <span className="breadcrumb-active">Our Process</span>
          </div>
          <div className="hero-badge"><div className="hero-dot" /> Simple · Transparent · Reliable</div>
          <h1>How We Work — <em>Step by Step</em></h1>
          <p>From your first call to the final handover — our proven 5-step process ensures every project is delivered smoothly, on time, and to the highest standard.</p>
        </div>
      </section>
              ...
              <div className="step-item" key={s.n}>
                ...
                <div className="step-right">
                  ...
                  <div className="step-points">
                    {s.points.map(pt => <span className="step-point" key={pt}>{pt}</span>)}
                  </div>
                </div>
              </div>
            ))}
      ...
      <div className="cta-band">
        ...
        <p>Contact us today — free consultation, site visit, and quotation at no cost.</p>
