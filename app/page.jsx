...
export default function Home() {
  ...
  const slides = [
    ...
    },
    {
      img: '/Interior7.jpg',
      tag: 'Interior Renovation',
      title: 'Modern Interiors, Timeless Style',
      desc: 'Expert interior design and renovation tailored to your lifestyle and vision.',
    },
    {
      img: '/pool4.webp',
      tag: 'Pool & Landscape',
    ...
    <>
      ...
      <nav className={scrolled ? 'scrolled' : ''}>
        ...
        <div className={`mobile-nav ${menuOpen ? 'open' : ''}`}>
          ...
          <a href="#process">Our Process</a>
          <a href="#contact">Contact</a>
          <a href="tel:+971559747416" className="mobile-cta">
            Call Now — +971 55 974 7416
          </a>
        </div>
      </nav>
      ...
      <div className="slider">
        ...
        <div className="slide-arrows">
          <button
            ...
            onClick={() =>
              goSlide((slideIndex - 1 + slides.length) % slides.length)
            }
          >
            <svg
              width="18"
        ...
        <div className="section-inner">
          <div className="section-header">
            ...
            <p className="section-sub">
              Comprehensive renovation and technical services delivered by
              expert teams across Dubai.
            </p>
          </div>
        ...
        <div className="section-inner">
          <div className="about-grid">
            <div className="about-img-wrap">
              <img
                src="/Interior7.jpg"
                alt="All Care Technical Services Interior"
              />
            ...
            <div className="about-content">
              ...
              <h2 className="section-title">
                Dubai&apos;s Trusted Renovation Partner
              </h2>
              <p>
                All Care Technical Services is a leading renovation and
                technical services company based in Dubai. We specialize in
                delivering high-quality interior and exterior renovation, pool
                construction, landscaping, and complete turnkey solutions.
              </p>
              <p>
                Our experienced team brings craftsmanship, attention to detail,
                and a commitment to excellence on every project — from small
                apartments to large commercial fit-outs.
              </p>
              <div className="about-features">
                <div className="about-feature">
                  ...
                  <div className="about-feature-text">
                    ...
                    <span>
                      Fully registered with Dubai Municipality and relevant
                      authorities.
                    </span>
                  </div>
                </div>
                <div className="about-feature">
                  ...
                  <div className="about-feature-text">
                    ...
                    <span>
                      Skilled team of engineers, designers, and technicians.
                    </span>
                  </div>
                </div>
                <div className="about-feature">
                  ...
                  <div className="about-feature-text">
                    ...
                    <span>
                      We listen, plan, and execute with your vision at the
                      center.
                    </span>
                  </div>
                </div>
      ...
      <section className="whyus-section">
        <div className="section-inner">
          <div className="section-header">
            ...
            <p className="section-sub">
              We go beyond construction — we build lasting relationships and
              exceptional spaces.
            </p>
          </div>
        ...
        <div className="section-inner">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <p className="section-sub" style={{ margin: '0 auto' }}>
              From first call to final handover — we make renovation
              stress-free.
            </p>
          </div>
      ...
      <div className="cta-band">
        ...
        <p>
          Get a free consultation and quote from our renovation experts today.
        </p>
          ...
          <div className="contact-grid">
            <div>
              ...
              <p className="section-sub" style={{ marginBottom: '1.75rem' }}>
                Contact us today for a free consultation and quotation. We are
      ...
      <footer>
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <p>
              Your trusted renovation and technical services partner in Dubai.
              Quality, integrity, and excellence on every project.
            </p>
        ...
        <div className="footer-bottom">
          <span>
            © 2025 All Care Technical Services LLC. All rights reserved.
          </span>
